import type { gameStates } from '@/constants/game';
import type { supportedNetworkIds } from "@/constants/blockchain/networks";
import type { durations } from '@/constants/durations';
...
export type Duration = typeof durations[number] /// price selection
